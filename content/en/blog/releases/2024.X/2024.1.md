...
The dependency on SQL Server has been [removed][removal of SQL Server] from {{% ctx %}} Gateway.
...
A number of [blocks have been improved][Improved Blocks] within the {{% ctx %}} Block Packages, improving functionality to work with:
...
* Updating scripts and documentation to reflect the [removal of SQL Server][]
...
| <nobr>&nbsp; &nbsp; > {{% ctx %}} Authorisation Service </nobr>            | 3.1.0.24130  | Yes     | Major                       | No              | Major changes occurred between internal development releases, however, these changes are not breaking between 2023.11 and 2024.1            |
...
| <nobr>{{% ctx %}} Gateway, including {{% ctx %}} Studio </nobr>            | 10.1.1.24130 | Yes     | Major                       | No              | Major changes occurred between internal development releases, however, these changes are not breaking between 2023.11 and 2024.1            |
| <nobr>{{% ctx %}} Blocks Package </nobr>                                   | 43.1.1.24120 | Yes     | Major                       | Potential       | Major changes occurred between releases, these changes are [potentially breaking][Potentially Breaking - Blocks] between 2023.11 and 2024.1 |
| <nobr>{{% ctx %}} Interaction Portal </nobr>                               | 1.0.0.24130  | Yes     | <nobr>First Release </nobr> | No              |                                                                                                                                             |
...
The dependency on SQL Server has been [removed][Removed - SQL Server Dependency] from {{% ctx %}} Gateway.
...
* Auto-generation of self-signed certificates now include SANs - the SANs included are: `localhost`, `127.0.0.1`, and wildcard domain (e.g. `*.domain.com`)
* The installation scripts have been updated to remove references to hard coded drive paths, and now use environment variables
...
If you have installed 2023.11 release and want to upgrade to 2024.1; please request assistance by raising a case in the {{% ctx %}} Service Portal.
