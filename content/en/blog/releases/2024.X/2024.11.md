...
| <nobr>[{{% ctx %}} Interaction Portal][Interaction Portal] </nobr>             | 3.0.1.24460   | Yes     | Major         | Yes             | Major changes occurred between releases, these changes are related to support of multiple Cortex Interaction Portal running on the same machine and are [breaking][Breaking - Added support for multiple Cortex Interaction Portal running on the same machine] |
