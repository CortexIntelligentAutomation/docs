...
| <nobr>&nbsp; &nbsp; > {{% ctx %}} Authorisation Service </nobr>            | 5.0.2.24340   | Yes     | Major       | No              | Major changes occurred between internal development releases, however, these changes are not breaking between 2024.5 and 2024.7                                                                                                               |
...
| <nobr>{{% ctx %}} Gateway, including {{% ctx %}} Studio </nobr>            | 10.33.1.24340 | Yes     | Minor       | No              |                                                                                                                                                                                                                                               |
| <nobr>{{% ctx %}} Blocks Package </nobr>                                   | 46.0.4.24340  | Yes     | Major       | Yes             | Flows will need to be upgraded <br/><br/> Compatibility Version: 31.24250                                                                                                                                                                     |
| <nobr>{{% ctx %}} Interaction Portal </nobr>                               | 2.0.0.24340   | Yes     | Major       | Yes             | The Interaction Portal flows will need to be upgraded                                                                                                                                                                                         |
...
{{% alert title="Note" %}}
This is a breaking change and will require a flow upgrade, which is documented in the upgrade flows steps.
{{% / alert %}}
...
Updated blocks with their new icon designs.
...
All flows that use the previous `Scope` data type will need to be upgraded.
