...
As of the 2024.7 release, unless patched, flows will need to be migrated due to the change related to the [Scope][] data type.

### Known Limitations

There are no known known limitations added as part of the 2024.7 release of the {{% ctx %}} Platform.
