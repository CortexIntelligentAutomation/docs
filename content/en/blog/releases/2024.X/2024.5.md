...
TODO: This requires a link
Services within the {% ctx %} platform no longer reference code shared with the {{% ctx %}} Licence Fingerprint Generator, and now invoke a local instance of the {{% ctx %}} Licence Fingerprint Generator when validating licenses. The installation now deploys the {{% ctx %}} Licence Fingerprint Generator to all required nodes.
...
TODO: Reach out for what versions
...
|--------------------------------------------------------------------------------|--------------------|---------|-------------|-----------------|-------|
| <nobr>[{{% ctx %}} Innovation Core Application][] </nobr>                      | 45.0.2.24250 TODO  | Yes     | Major       | Potential       | TODO  |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} API Gateway Service][] </nobr>              | 35.0.1.24250 TODO  | Yes     | Major       | Potential       | TODO  |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Authorisation Service][]                    | 4.0.15.24250 TODO  | Yes     | Patch       | No              |       |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Concurrency Management Service][] </nobr>   | 4.0.1.24250 TODO   | Yes     | Major       | Potential       | TODO  |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Configuration Management Service][] </nobr> | 3.2.11.24250 TODO  | Yes     | Patch       | No              |       |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Data Storage Service][] </nobr>             | 5.0.1.24250 TODO   | Yes     | Major       | Potential       | TODO  |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Execution Management Service][] </nobr>     | 4.0.18.24250 TODO  | Yes     | Patch       | No              |       |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Licence Management Service][] </nobr>       | 4.0.15.24250 TODO  | Yes     | Patch       | No              |       |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Package Management Service][] </nobr>       | 8.1.3.24250 TODO   | Yes     | Minor       | No              |       |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Provisioning Service][] </nobr>             | 9.0.16.24250 TODO  | Yes     | Patch       | No              |       |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Scheduling Service][] </nobr>               | 4.1.10.24250 TODO  | Yes     | Patch       | No              |       |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Triggers Service][] </nobr>                 | 6.1.10.24250 TODO  | Yes     | Patch       | No              |       |
| <nobr>[{{% ctx %}} Innovation Execution Application][] </nobr>                 | 31.0.2.24250 TODO  | Yes     | Major       | Potential       | TODO  |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Execution Service][] </nobr>                | 17.0.1.24250 TODO  | Yes     | Major       | Potential       | TODO  |
| <nobr>[{{% ctx %}} Gateway][Gateway], including [{{% ctx %}} Studio][] </nobr> | 10.22.4.24260 TODO | Yes     | Minor       | No              |       |
| <nobr>[{{% ctx %}} Blocks Package][Blocks] </nobr>                             | 44.3.0.24260 TODO  | Yes     | Major       | TODO            | TODO  |
...
TODO - Update title - Fingerprint reference removed...
TODO - Change subject services no longer use... etc..
