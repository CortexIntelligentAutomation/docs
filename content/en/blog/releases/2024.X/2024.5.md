...
|--------------------------------------------------------------------------------|---------------|-----------------------------|-----------------------------|-----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <nobr>[{{% ctx %}} Innovation Core Application][] </nobr>                      | 45.0.2.24250 TODO  | Yes                         | Major                       | Potential       | |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} API Gateway Service][] </nobr>              | 35.0.1.24250 TODO  | Yes                         | Major                       | Potential       | |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Authorisation Service][]                    | 4.0.15.24250 TODO   | Yes                         | Patch                       | No       | |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Concurrency Management Service][] </nobr>   | 4.0.1.24250 TODO   | Yes                         | Major                       | Potential       | |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Configuration Management Service][] </nobr> | 3.2.11.24250 TODO   | Yes                         | Patch                       | No       | |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Data Storage Service][] </nobr>             | 5.0.1.24250 TODO   | Yes                         | Major                       | Potential       |  |
...
| <nobr>[{{% ctx %}} Innovation Execution Application][] </nobr>                 | 31.0.2.24250 TODO  | Yes                         | Major                       | Potential       | |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Execution Service][] </nobr>                | 17.0.1.24250 TODO  | Yes                         | Major                       | Potential       | |
| <nobr>[{{% ctx %}} Gateway][Gateway], including [{{% ctx %}} Studio][] </nobr> | 10.22.4.24260 TODO | Yes                         | Minor                       | No              |                                                                                                                                                                                         |
| <nobr>[{{% ctx %}} Blocks Package][Blocks] </nobr>                             | 44.3.0.24260 TODO | Yes                         | Major                       | No              |                                                                                                                                                                                         |
...
| <nobr>{{% ctx %}} Web App Server Install Scripts </nobr>                       | 9.0.0.24240   | Yes                         | Major                       | No              |                                                                                                                                                                                         |
