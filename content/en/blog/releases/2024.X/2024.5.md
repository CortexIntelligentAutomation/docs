...
|--------------------------------------------------------------------------------|--------------------|---------|-------------|-----------------|-------|
| <nobr>[{{% ctx %}} Innovation Core Application][] </nobr>                      | 45.0.5.24260  | Yes     | Major       | Potential       | TODO  |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} API Gateway Service][] </nobr>              | 35.0.4.24260  | Yes     | Major       | Potential       | TODO  |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Authorisation Service][]                    | 4.0.18.24260  | Yes     | Patch       | No              |       |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Concurrency Management Service][] </nobr>   | 4.0.4.24260   | Yes     | Major       | Potential       | TODO  |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Configuration Management Service][] </nobr> | 3.2.14.24260  | Yes     | Patch       | No              |       |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Data Storage Service][] </nobr>             | 5.0.4.24260   | Yes     | Major       | Potential       | TODO  |
...
| <nobr>[{{% ctx %}} Innovation Execution Application][] </nobr>                 | 31.0.4.24260  | Yes     | Major       | Potential       | TODO  |
| <nobr>&nbsp; &nbsp; > [{{% ctx %}} Execution Service][] </nobr>                | 17.0.4.24260  | Yes     | Major       | Potential       | TODO  |
| <nobr>[{{% ctx %}} Gateway][Gateway], including [{{% ctx %}} Studio][] </nobr> | 10.23.2.24260 | Yes     | Minor       | No              |       |
| <nobr>[{{% ctx %}} Blocks Package][Blocks] </nobr>                             | 44.3.1.24260  | Yes     | Major       | TODO            | TODO  |
