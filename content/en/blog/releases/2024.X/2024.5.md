...
| <nobr>[{{% ctx %}} Blocks Package][Blocks] </nobr>                             | 44.3.1.24260  | Yes     | Major       | Potential            | Major changes occurred between releases, these changes are related to te extended scope and are [potentially breaking][Potentially Breaking - Scope] between 2024.3 and 2024.5  |
