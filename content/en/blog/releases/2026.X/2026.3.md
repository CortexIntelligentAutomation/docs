...
Running the new 'TODO: script name' on the wiped machine will ensure it automatically rejoins both the `RabbitMQ` cluster and the [Service Fabric][Service Fabric] cluster without requiring manual intervention.
