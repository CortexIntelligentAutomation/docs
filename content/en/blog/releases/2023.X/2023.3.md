...
A new web application called [Interaction Portal][] has been developed to support [Human-in-the-Loop][] automation in Cortex Innovation deployments, which was previously provided by Live Portal in the 7.X generation of the platform.
...
A new [Welcome Page][] has been added to [Cortex Gateway][Gateway]. It acts as a landing page when signing in and provides the ability to quickly navigate to the last 20 recently edited flows for the signed-in user.
