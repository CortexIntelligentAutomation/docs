...
- The CORTEX Flow Execution Service has been split into three new services: the [{{< ctx >}} Licence Management Service][CORTEX Licence Management Service], the [{{< ctx >}} Package Management Service][CORTEX Package Management Service], the [{{< ctx >}} Execution Services][CORTEX Execution Service]
