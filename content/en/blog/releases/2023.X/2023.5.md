...
* [Flows][] - Allowing for the execution of asynchronous flows, returning a task that can waited for or cancelled at a later point in a flow
...
* [Telnet][] - Allowing for connection to a Telnet hosts, executing commands against them and returning their responses
...
[Run Flow Async - Known Limitations]: {{< url path="Cortex.Reference.Blocks.Flows.KnownLimitations" version="2023.5" >}}
...
[Http Request block]: {{< url path="Cortex.Reference.Blocks.Http.ExecuteHttpRequest.ExecuteHttpRequest" version="2023.5" >}}
