...
Currently, the Data Storage Service can only be accessed using the API, or by using the [Execute Http Request][] block within a flow. Dedicated blocks will be provided to interact with this service in a future release.
