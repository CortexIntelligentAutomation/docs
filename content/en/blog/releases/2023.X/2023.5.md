...
The [Data Storage Service][CORTEX Data Storage Service] has been added to the HA Platform, which allows for sharing of data between flow executions. The data will be segregated by tenant/system.
