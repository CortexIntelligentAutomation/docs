...
The Configuration Management service has been added to the HA Platform architecture which currently allows managing tenants/systems for a deployed {{% ctx %}} Innovation.

An API has been to manage tenants/systems, such as:
...
The Data Storage service has been added to the HA Platform architecture which currently allows sharing data between executions. An API has been added to read and write data. The data is segregated by system/tenant.
...
The [blocks][] help documentation has been updated for the new [Telnet][] block, as well as SSH documentation for the SshLogs and SshSessionDetails data types.
