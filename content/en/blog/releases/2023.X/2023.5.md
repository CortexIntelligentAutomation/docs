...
The [Configuration Management][CORTEX Configuration Management Service] service has been added to the HA Platform, which currently allows managing tenants/systems for deployed {{% ctx %}} Innovation instances.
...
The Product Portal has been rebranded to follow We Are CORTEX branding guidelines, the documentation has also been updated to reflect the [new and upcoming services][HA Platform], and reference documentation has also been added for the [new blocks][New Blocks].
