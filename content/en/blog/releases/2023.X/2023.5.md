...
The [Data Storage Service][CORTEX Data Storage Service] has been added to the HA Platform architecture, which currently allows sharing of data between executions. The data will be segregated by tenant/system.
