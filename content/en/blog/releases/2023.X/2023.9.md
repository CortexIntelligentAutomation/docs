...
TODO LINK : {{% ctx %}} Gateway has been rebranded and theme support for light and dark mode has been added.

TODO LINK : Support for Windows Server 2022 has been added to the Innovation Platform as part of the 2023.9 release, and support for Windows Server 2016 has been removed.
...
#### Grafana Promtail Problem Details Incorrect Reporting of 4xx 5xx as successful
...
#### Collection Scope default not set
...
This is potentially breaking if you were . Any occurrence of this will need to be updated to use the new name.
