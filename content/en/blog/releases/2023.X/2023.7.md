...
This can be configured for each flow, by using the [new common block property][New Common Properties] for [semaphores][Semaphore Property] available on most blocks.
