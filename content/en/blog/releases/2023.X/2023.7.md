...
* [Concurrency Management Service][] - Allows for sharing of data between flow executions
* [Scheduling Service][] - Allows for future management of tenants/systems and platform configuration of a deployed {{% ctx %}} Innovation platform

Five [new Blocks][New Blocks] have been added to the [{{% ctx %}} Block Packages][Blocks], adding new functionality to work with:

* [Data Storage][] - Allowing for the creation and deletion of collections within the [Data Storage Service][CORTEX Data Storage Service], and the capability to delete, read, and write data to these collections
...
* [Semaphore][Semaphore Property] - Allowing for the execution of the block to be limited and controlled by the access to a specific semaphore
...
| &nbsp; &nbsp; > [{{% ctx %}} Concurrency Management Service][CORTEX Concurrency Management Service]     | 1.1.5.23250  | Yes                  | Major         |                                                                              |
| &nbsp; &nbsp; > [{{% ctx %}} Configuration Management Service][CORTEX Configuration Management Service] | 1.1.5.23250  | Yes                  | Major         |                                                                              |
| &nbsp; &nbsp; > [{{% ctx %}} Data Storage Service][CORTEX Data Storage Service]                         | 1.0.2.23250  | Yes                  | Major         |                                                                              |
| &nbsp; &nbsp; > [{{% ctx %}} Execution Management Service][CORTEX Execution Management Service]         | 2.0.0.23260  | Yes                  | Major         |                                                                              |
...
| &nbsp; &nbsp; > [{{% ctx %}} Scheduling Service][CORTEX Scheduling Service]                             | 6.1.0.23260  | Yes                  | First Release |                                                                              |
...
##### New Scheduling Management Service
...
Two new [Common Properties][] have been added to the Innovation platform to work with:
...
Known limitations have been added within the 2023.7 release on the following pages:
...
If you are installing a new 2023.7 platform or adding it to an existing 7.2 Installation see the guidance below; otherwise, if you are upgrading from an existing 2023.3 platform refer to the [Upgrade Instructions][].
...
[New Common Properties]: {{< ref "#new-common-properties" >}}
...
[Semaphore Property]: {{< url path="Cortex.Reference.Concepts.Fundamentals.Blocks.BlockProperties.SemaphoreProperty" version="2023.7" >}}
[Run As Property]: {{< url path="Cortex.Reference.Concepts.Fundamentals.Blocks.BlockProperties.RunAsProperty" version="2023.7" >}}
...
[SSH data types]: {{< url path="Cortex.Reference.DataTypes.Ssh.MainDoc" version="2023.7" >}}
[SshLogs]: {{< url path="Cortex.Reference.DataTypes.Ssh.SshLogs.MainDoc" version="2023.7" >}}
[SshSessionDetails]: {{< url path="Cortex.Reference.DataTypes.Ssh.SshSessionDetails.MainDoc" version="2023.7" >}}
...
[Packages]: {{< url path="Cortex.Guides.Gateway.Settings.Packages.MainDoc" version="2023.7" >}}
