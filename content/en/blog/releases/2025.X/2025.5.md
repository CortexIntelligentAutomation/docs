...
<!-- http://localhost:1313/docs/2025.5/reference/concepts/fundamentals/executions/what-is-an-execution/#execution-context -->
...
* `Executed On`: Where the execution is running, in the following format `<node-name> (<ipaddress-or-fqdn>)`.
...
| Action                | Single Node                             | Multi Node                             |
|-----------------------|-----------------------------------------|----------------------------------------|
| Disable Code Analyser | [Disable Code Analyser - Single Node][] | [Disable Code Analyser - Multi Node][] |
| Update Allowed list   | [Update Allowed list - Single Node][]   | [Update Allowed list - Multi Node][]   |
