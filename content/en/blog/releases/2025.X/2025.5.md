...
| <nobr>{{% ctx %}} Gateway </nobr>                                            | 13.5.0.25260  | Yes     | Major       | Yes             | Major changes occurred between releases, these changes are related to the Code Analyser that restricts what C# code can be executed from flows within CORTEX and is [breaking][Breaking - Introduced Code Analyser to the {{% ctx %}} Execution Service] between 2025.3 and 2025.5. |
| <nobr>{{% ctx %}} Blocks Package </nobr>                                     | 48.5.1.25260  | Yes     | Minor       | N/A             |                                                                                                                                                                                                                                                                                     |
| <nobr>{{% ctx %}} Interaction Portal </nobr>                                 | 3.2.0.25260   | Yes     | Minor       | N/A             |                                                                                                                                                                                                                                                                                     |
