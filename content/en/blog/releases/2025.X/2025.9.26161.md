...
#### Enchanced the handling of untranslated SNMP v1 Traps

For SNMP v1 traps without a matching MIB, CORTEX now extracts trap details directly from the trap OID when the GenericTrapType is valid (0–6).
