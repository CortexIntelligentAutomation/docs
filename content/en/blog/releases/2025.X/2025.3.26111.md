...
The ExecutionContext now contains the service details, providing information about the service that the execution is running on, including: the service name, type, version, partition ID, replica or instance ID, and process ID.
