...
* [Added Encryption Endpoint to {{% ctx %}} API Gateway Service][Capability - Added Encryption Endpoint to {{% ctx %}} API Gateway Service]
* [Added the ability to encrypt values in the {{% ctx %}} Configuration Portal][Capability - Added the ability to encrypt values in the {{% ctx %}} Configuration Portal]
...
[Capability - Added Encryption Endpoint to {{% ctx %}} API Gateway Service]: {{< ref "#added-encryption-endpoint-to-cortex-api-gateway-service" >}}
[Capability - Added the ability to encrypt values in the {{% ctx %}} Configuration Portal]: {{< ref "#added-the-ability-to-encrypt-values-in-the-cortex-configuration-portal" >}}
