1. Copy the following artefact to a folder on the Web Application Server:
   * Cortex Innovation 2025.9 - Flows Upgrader.zip
1. Extract the `Cortex Innovation 2025.9 - Flows Upgrader.zip` file to a folder with the same name.
...
1. Navigate PowerShell to inside the `Cortex Innovation 2025.9 - Flows Upgrader` folder using the following command, modifying the path as necessary:

    ```powershell
    cd "C:\Install\Cortex Innovation 2025.9 - Flows Upgrader"
    ```
