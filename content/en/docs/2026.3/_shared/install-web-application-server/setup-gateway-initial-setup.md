To complete the initial setup of {{% ctx %}} Gateway follow the steps below. See the [Initial Setup][Initial Setup tutorial] tutorial for a step-by-step guide.
...
[Initial Setup tutorial]: {{< url path="Cortex.Tutorials.Setup.SetupGateway.InitialSetup" >}}
