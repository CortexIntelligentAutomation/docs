...
1. Copy the output (Machine Name and Fingerprint) to the `Web Application/Application Server` section of the text file created in the initial step. Note that the Machine Name can be changed to any string.
